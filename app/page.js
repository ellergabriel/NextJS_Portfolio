...
const Portfolio = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      {/* Hero Section */}
      <section id="home"className="relative py-20 px-4 bg-black/90">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-white-600 mb-6">
            Graduate Student and Math Educator
          </h2>
          <p className="text-xl text-white-600 mb-8 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="#contact" className="border border-gray-300 text-white-700 px-8 py-3 rounded-lg hover:bg-gray-50 transition-colors font-medium">
              Get In Touch
            </a>
          </div>
        </div>
